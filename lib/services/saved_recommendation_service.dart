...
class SavedRecommendationService {
  ...
  Future<void> saveRecommendation({
    ...
    await _supabase.from('saved_recommendations').insert({
      'user_id': user?.id,
      ...
      'advantages': recommendation.reasons,

      'cautions': recommendation.cautions,
    });
  }

  Future<List<Map<String, dynamic>>> getSavedRecommendations() async {
    final user = _supabase.auth.currentUser;

    dynamic query = _supabase.from('saved_recommendations');
